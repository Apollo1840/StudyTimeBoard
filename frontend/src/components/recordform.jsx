                    ...
                    <div className="jumbotron">
                            <div id="greeting_user">
                                ...
                                <div className="row">
                                    <div className="input-group mb-5 ml-3 mr-3">
                                        <div></div>
                                        <input type="text" className="form-control" placeholder="Type here your username (* must)" name="username" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="go_hold_buttons">
                                <div className="row" style={{color: "#AAA"}}>
                                    <p className="ml-3"> Click "Go“ or ”Hold“ when you start or end the study period: </p>
                                </div>
                                <div className="row" id="the_buttons">
                                    <div className="col text-center">
                                        <button className="btn btn-outline-primary"
                                                id="go"
                                                style={{width: "100px", height:"100px", fontSize:"140%", borderRadius: "50%"}} name="go"
                                    ...
                                    <div class="col text-center">
                                        <button class="btn btn-outline-primary"
                                                id="hold"
                                                style={{width: "100px", height:"100px", fontSize:"140%", borderRadius: "50%"}} name="hold"
                            ...
                            <div id="duration_input">
                                <div className="row">
                                    <p style={{color: "#AAA"}} className="ml-3"> Or input concrete time interval: </p>
                                </div>
                                ...
                                <div className="row">
                                    <div className="col input-group mb-3 mr-5">
                                        ...
                                        <input type="text" className="form-control" placeholder="eg. 09:00" name="start_time" />
                
                                    </div>
                
                                    <div className="col input-group mb-3 ml-5">
                                        <div className="input-group-prepend">
                                            <span className="input-group-text" id="basic-addon2">end time</span>
                                        </div>
                                        <input type="text" className="form-control" placeholder="eg. 18:00" name="end_time" />
